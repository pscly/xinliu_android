...
- [x] 14. M2.1 首页时间线重做（日期分组 + 密度留白）
- [x] 15. M2.2 图片图版
- [x] 16. M2.3 MemoItem 重构
- [x] 17. M2.4 宽屏自适应 + 列表形态设置
- [x] 18. M2.5 滑动手势 + 动作池
- [x] 19. M2.6 收藏领域接线（内置收藏文件夹）
- [x] 20. M2.7 Markdown 引擎切换 mikepenz
- [x] 21. M2.8 编辑器重构（着色 + 预览 + 双栏）
- [x] 22. M2.9 转场编排 + ReducedMotion 扩展
- [x] 23. M2.10 M3 组件纸墨化
- [x] 24. M2.R 里程碑 2 验收 + 发布 1.11.0 闭环

### 里程碑 3：全屏迁移 + 无障碍

- [x] 25. M3.1 逐屏迁移（顶层分区顺序）
- [x] 26. M3.2 无障碍清债
- [x] 27. M3.3 阅读模式字号/行距
- [x] 28. M3.4 状态原语
- [x] 29. M3.5 DESIGN.md / CONTEXT.md 文档回写
- [x] 30. M3.R 里程碑 3 验收 + 发布 1.12.0 闭环

## Final Verification Wave

- [x] F1. 目标与约束核对（对照 ADR 0008–0011 + 本计划不变量）
- [x] F2. 代码质量与架构审查
- [x] F3. 安全与敏感路径审查
- [x] F4. 端到端 / 门禁复验（lint + 单测 + 截图矩阵 + 包名/版本/签名）

...
object FlowBackendModule {
    ...
    @Singleton
    @Named("flowBackend")
    fun provideFlowBackendOkHttpClient(
    ...
    @Singleton
    @Named("flowBackend")
    fun provideFlowBackendRetrofit(
        @Named("flowBackend") client: OkHttpClient,
    ): Retrofit {
    ...
    fun provideFlowBackendApi(
        @Named("flowBackend") retrofit: Retrofit,
    ): FlowBackendApi = retrofit.create(FlowBackendApi::class.java)

    @Provides
    @Singleton
    fun provideFlowSyncApi(
        @Named("flowBackend") retrofit: Retrofit,
    ): FlowSyncApi = retrofit.create(FlowSyncApi::class.java)
}
